...
!
      ...
      real,dimension(360,180)::                      &
          ...
          light1,prec601,prec101,precd1,dp1,agr1,gdp1,peatf1
!Huilin add ncid_light ncid_Dp ncid_agr ncid_gdp ncid_peatf
!
      ...
      character(len=100):: file_prec60
      character(len=100):: file_prec10
      character(len=100):: file_precd
...
!       
!     iyear = 1948
      iyear = iyear1                    !10/2/2017 Huilin use iyear1 for real forcing
!=========Reading netcdf data ===================
!
...
!
!      indir='/home7/xue/gsong/ncdata/4806'
!!!   indir='/glade/p/work/hlhuang/data/ncdata_4806clim/'
      indir='/gpfs/fs1/scratch/yeliu/data/ncdata/'
      indirfire='/glade/work/hlhuang/data/ncdata_4808/'
      indirlen=len_trim(indir)
      file_dswrf= indir(1:indirlen)//'/dswrf_3hourly_'//syear//'-'//syear//'.nc'
      file_dlwrf= indir(1:indirlen)//'/dlwrf_3hourly_'//syear//'-'//syear//'.nc'
      file_pres = indir(1:indirlen)//'/pres_3hourly_'//syear//'-'//syear//'.nc'
      file_tas  = indir(1:indirlen)//'/tas_3hourly_'//syear//'-'//syear//'.nc'
      file_prcp = indir(1:indirlen)//'/prcp_3hourly_'//syear//'-'//syear//'.nc'
      file_shum = indir(1:indirlen)//'/shum_3hourly_'//syear//'-'//syear//'.nc'
      file_wind = indir(1:indirlen)//'/wind_3hourly_'//syear//'-'//syear//'.nc'
      indirfirelen=len_trim(indirfire)
      file_light= indirfire(1:indirfirelen)//'/light_3hourly_'//syear//'-'//syear//'.nc'
      file_prec60= indirfire(1:indirfirelen)//'/prcp60_3hourly_'//syear//'-'//syear//'.nc'
      file_prec10= indirfire(1:indirfirelen)//'/prcp10_3hourly_'//syear//'-'//syear//'.nc'
      file_precd = indirfire(1:indirfirelen)//'/prcpd_3hourly_'//syear//'-'//syear//'.nc'
      file_dp   = indirfire(1:indirfirelen)//'/dp_3hourly_'//syear//'-'//syear//'.nc'
      file_agr  = indirfire(1:indirfirelen)//'/agr_annual_'//syear//'-'//syear//'.nc'
      file_gdp  = indirfire(1:indirfirelen)//'/gdp_annual_'//syear//'-'//syear//'.nc'
      file_peatf= indirfire(1:indirfirelen)//'/peatf_3hourly_'//syear//'-'//syear//'.nc'
!Huilin add light Dp agr gdp peatf
      ...
      call netcdf_open_rf(file_prec60,NCID_PREC60)
      call netcdf_open_rf(file_prec10,NCID_PREC10)
      call netcdf_open_rf(file_precd,NCID_PRECD)
...
!Huilin add light Dp agr gdp peatf
      ...
      call netcdf_read0(1,360,1,180,krec, ncid_light,"light",light1)
      call netcdf_read0(1,360,1,180,krec, ncid_prec60,"prcp",prec601)
      call netcdf_read0(1,360,1,180,krec, ncid_prec10,"prcp",prec101)
      call netcdf_read0(1,360,1,180,krec, ncid_precd,"prcp",precd1)
      call netcdf_read0(1,360,1,180,1, ncid_dp,"dp",dp1)
      call netcdf_read0(1,360,1,180,1, ncid_agr,"agr",agr1)
      call netcdf_read0(1,360,1,180,1, ncid_gdp,"gdp",gdp1)
      call netcdf_read0(1,360,1,180,1, ncid_peatf,"peatf",peatf1)
!Huilin add light Dp agr gdp peatf
      ...
      do j=latg2s,latg2e
        ...
        prec60(i,j)= prec601(i,j)
        prec10(i,j)= prec101(i,j)
        precd(i,j) = precd1(i,j)
        dp(i,j)    = dp1(i,j)
        agr(i,j)   = agr1(i,j)
        gdp(i,j)   = gdp1(i,j)
...
!
      if(krec.eq.ke) then
         ...
         call netcdf_close(NCID_PREC60)
         call netcdf_close(NCID_PREC10)
         call netcdf_close(NCID_PRECD)
