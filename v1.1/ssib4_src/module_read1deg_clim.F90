...
!     indir='/gpfs/fs1/scratch/yeliu/data/ncdata/clim/'
      indirfire='/gpfs/fs1/work/hlhuang/data/ncdata_4806clim/'
      ...
      file_prec60= indirfire(1:indirfirelen)//'prcp60_3hourly_1952-1952.nc'
      file_prec10= indirfire(1:indirfirelen)//'prcp10_3hourly_1952-1952.nc'
      file_precd = indirfire(1:indirfirelen)//'prcpd_3hourly_1952-1952.nc'
      file_dp   = indirfire(1:indirfirelen)//"dp_3hourly_1948-1948.nc"
      file_agr  = indirfire(1:indirfirelen)//"agr_annual_1948-1948.nc"
      file_gdp  = indirfire(1:indirfirelen)//"gdp_annual_1948-1948.nc"
