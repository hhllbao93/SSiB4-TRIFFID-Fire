...
!
      ...
      real::  psurf,sig,tdd
      real:: umm1,vmm1,RCL,ZWIND,wind,LIGHT,PREC60,PREC10,PRECD,DP,AGR,GDP,PEATF               !Huilin add fire variables 
!
      real::                                                    &
        SUNANG,RLWDOWN,radn11,radn12,radn21,radn22,RADNSUM,     &
        TM,UMM,VMM,QM,EM,rhoair,co2ca,zlon,zlat
      real:: PPL,PPC,PREC                  !(mm) Huilin add PREC Jul 2019
!
      real:: xhlflx,xhsflx
      real:: cs,ci,gb,gs
      real::                                                    &
...
!yliu09May2017
      ...
      real:: LH,IGN,FM_AVG,FT_AVG,FB_AVG,FM_FIRE      !Huilin May 11 for debug
      real:: FCLI,FSAT,BAF_PEAT                                       !Huilin add fire output
      real:: BAF_AVG,NFIRE_AVG,BURN_AVG,BURN_PEAT                     !Huilin add fire output
      real:: BAF_AVG60
...
!
       ...
       outdat % QBAF_AVG60= 0.0 !Huilin Huang
       outdat % QBAF_PEAT = 0.0 !Huilin Huang
       outdat % QBURN_AVG = 0.0 !Huilin Huang Mar 2019
       outdat % QBURN_PEAT= 0.0 !Huilin Huang Mar 2019
       outdat % QNFIRE_AVG= 0.0 !Huilin Huang
       outdat % QLH       = 0.0 !Huilin Huang May 11 2020
       outdat % QIGN      = 0.0 !Huilin Huang May 11 2020
       outdat % QFM_AVG   = 0.0 !Huilin Huang May 11 2020
       outdat % QFT_AVG   = 0.0 !Huilin Huang May 11 2020
       outdat % QFB_AVG   = 0.0 !Huilin Huang May 11 2020
       outdat % QFM_FIRE  = 0.0 !Huilin Huang May 11 2020
       outdat % QAGR      = 0.0 !Huilin Huang May 11 2020
...
!yliu18Oct2016
      ...
      ENDIF
         ...
         LIGHT,PREC60,PREC10,PRECD,DP,AGR,GDP,PEATF,                   &!Huilin add all input in this line 
!out.......................................................
         TD,TGS,TC,TA,                                                 &
...
!TRIF output to GCM
         ...
         LIT_C,LIT_C_T,BAF_AVG60,                                      &
         AGB_AVG,FEO_AVG,FES_AVG,FE1_AVG,FE2_AVG,FD_AVG,FCLI,FSAT,     &
         LH,IGN,FM_AVG,FT_AVG,FB_AVG,FM_FIRE,                          &
         BAF_AVG,BAF_PEAT,NFIRE_AVG,BURN_AVG,BURN_PEAT,BURN_FIRE,      &  !Huilin add for fire output       
...
!Huilin Huang add fire variables
       ...
       outdat % qlh       = lh     !huilin huang may 11 2020
       outdat % qign      = ign    !huilin huang may 11 2020
       outdat % qfm_avg   = fm_avg !huilin huang may 11 2020
       outdat % qft_avg   = ft_avg !huilin huang may 11 2020
       outdat % qfb_avg   = fb_avg !huilin huang may 11 2020
       outdat % qfm_fire  = fm_fire!huilin huang may 11 2020
       outdat % qagr      = agr    !huilin huang may 11 2020
       outdat % qfcli     = fcli 
       outdat % qfsat     = fsat 
       outdat % qpeatf    = peatf
       outdat % qbaf_avg  = baf_avg
       outdat % qbaf_peat = baf_peat
       outdat % qburn_avg = burn_avg
       outdat % qburn_peat= burn_peat
       ...
       outdat % qem_oc    = em_oc
       outdat % qem_bc    = em_bc
       outdat % qprec60_avg = prec60
       outdat % qbaf_avg60  = baf_avg60
!
       DO K=1,NTYPET
